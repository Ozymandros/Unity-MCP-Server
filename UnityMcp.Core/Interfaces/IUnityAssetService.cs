...
public interface IUnityAssetService
{
    ...
    Task<string> ApplyFileChangeAsync(string projectPath, string fileName, string content, IUnityService.AgentEditMode mode = IUnityService.AgentEditMode.CreateOrEdit, CancellationToken cancellationToken = default);
